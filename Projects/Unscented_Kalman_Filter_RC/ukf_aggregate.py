...
from stationsim.ukf import plots,animations
import numpy as np
    ...
    def heatmap(self,a,poly_list):
        ...
        for i in range(a.shape[0]):
            ...
            if np.abs(np.nansum(locs))>0:
                ...
                frame.plot(column="counts",ax=ax,cmap=cmap,norm =DivergingNorm(0.01,0.1,0,0.9),legend=True)
...
if __name__ == "__main__":
    ...
    distances2,t_mean2 = plts.diagnostic_plots(actual,preds,True,True)
